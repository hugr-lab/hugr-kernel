...
- Go 1.26.1 (kernel), Python 3.11 (connection service), TypeScript 5.x (JupyterLab extension) + ornado (existing), `hugr.client` (existing), `@jupyterlab/application` (existing), `authlib` (new — OIDC/PKCE for Python) (008-oidc-browser-login)
